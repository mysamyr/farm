...
export const arenaGameTranslation: ArenaTranslation = {
  ...
  ruleLabels: {
    [GAME_RULES.ZERO_COOLDOWN]: 'Немає перезаряджання на початку',
  },
  util: {
    self: 'собі',
    opponent: 'супернику',
...
export const arenaHelpTranslation: ArenaHelpTranslation = {
  ...
  turnSteps: [
    ...
    'Перевірка смерті',
    'Обробити активні ефекти на собі (DoT / Регенерація) — пропустити Кровотечу, Отруту та Регенерацію, накладені в цей хід',
    'Перевірка смерті',
